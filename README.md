...
<matrix_file>: path to your Matrix Market .txt file.
...
The run_experiments_90p.sh script automates running all codes on multiple matrices, threads, chunks, schedules, and σ values.

How to run the bash script:

chmod +x run_experiments_90p.sh
./run_experiments_90p.sh
Configuration
At the top of run_experiments_90p.sh, you can adjust:
